...
$messages = array(
    'outdated' => array(
        ...
        'message' => sprintf( __( 'Your %1$s version (%2$s) is not recommended with. Please, update your web server to %3$s or greater.', 'wp-healthcheck' ), $server_data['web']['service'], $server_data['web']['version'], $requirements[ $server_data['web']['service'] ]['stable'] ),
    ),
    'obsolete' => array(
        'class'   => 'notice-error is-dismissible',
        /* translators: %1$s is the current database service (MySQL, MariaDB, etc), %2$s is the database version installed on server, %3$s is the version that WP team recommends */
        'message' => sprintf( __( 'The %1$s version you are using (%2$s) is not recommended and is deprecated! Please contact your developers and/or hosting company to upgrade your %1$s to version %3$s or greater.', 'wp-healthcheck' ), ucfirst( $server_data['web']['service'] ), $server_data['web']['version'], $requirements[ $server_data['web']['service'] ]['stable'] ),
    ),
);
?>
