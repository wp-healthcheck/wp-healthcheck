...
<div class="wphc_system_info">
	<ul>
		...
		<li class="<?php echo $server->is_software_updated( 'wp' ); ?>"><?php echo $server_data['wp']; ?></li>
	</ul>
	<ul>
		<li><?php _e( 'PHP', 'wp-healthcheck' ); ?></li>
		<li class="<?php echo $server->is_software_updated( 'php' ); ?>"><?php echo $server_data['php']; ?></li>
	</ul>
	<ul>
		...
		<li class="<?php echo $server->is_software_updated( strtolower( $server_data['database']['service'] ) ); ?>"><?php echo $server_data['database']['version']; ?></li>
	</ul>
	...
	<?php if ( ! empty( $web_server ) ) : ?>
		<ul>
			...
			<li class="<?php echo $server->is_software_updated( $server_data['web']['service'] ); ?>"><?php echo $web_server; ?></li>
		</ul>
	<?php endif; ?>
</div>
